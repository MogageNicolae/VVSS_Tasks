...
public class Controller {
    ...
    @FXML
    public void showNewTaskDialog(ActionEvent actionEvent) {
    ...
    @FXML
    public void showEditTaskDialog(ActionEvent actionEvent) {
        Object source = actionEvent.getSource();
        NewEditController.setClickedButton((Button) source);
    ...
    public void showFilteredTasks() {
        try {
            ...
            log.error("error filtering tasks");
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Error");
            alert.setHeaderText("Error filtering tasks");
